            ...
            <div className='inner-content h-full flex flex-col bg-white dark:bg-slate-800'>
              <div className='auth-box h-full flex flex-col justify-center'>
                <div className='mobile-logo text-center mb-6'>
                  <Link href='/'>
                    <img
                      src={isDark ? "logo_hitam.svg" : "logo_hitam.svg"}
                      alt=''
                      className='mx-auto'
                    />
                  </Link>
            ...
            <div className='flex flex-col h-full justify-center'>
              <div className='flex-1 flex flex-col justify-center items-center'>
                <Link href='/' className='flex justify-center'>
                  <img src='logo.png' alt='' className='mb-4 w-3/4' />
                </Link>
                <h3 className='max-w-[525px] mx-auto py-10 text-center text-appPrimary-500 font-bold'>
                  KEMENTERIAN PERTANIAN
                </h3>

                <h3 className='max-w-[525px] mx-auto pb-20 text-center font-semibold text-appPrimary-500 text-3xl'>
                  Balai Besar Pelatihan Pertanian{" "}
                  <span className='font-bold'>BATANGKALUKU</span>
                </h3>
              </div>
            </div>
          </div>
